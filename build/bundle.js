...
var app = (function () {
    ...
    var chevronDown = { 'chevron-down': { width: 1792, height: 1792, paths: [{ d: 'M1683 808l-742 741q-19 19-45 19t-45-19l-742-741q-19-19-19-45.5t19-45.5l166-165q19-19 45-19t45 19l531 531 531-531q19-19 45-19t45 19l166 165q19 19 19 45.5t-19 45.5z' }] } };
    ...
    function writableStorage(key, initValue) {
    ...
    function getInitPostIt(boardId, x = 20, y = 20) {
    	return {
    		id: getUuid(),
    		boardId: boardId,
    		content: '',
    ...
    const boardList = writableStorage('boardList', [initBoard]);
    const activeBoard = writableStorage('activeBoard', initBoard);
    const postItList = writableStorage('postItList', []);

    /* src/components/BoardList.svelte generated by Svelte v3.38.2 */
    const file$3 = "src/components/BoardList.svelte";
    ...
    // (50:2) {#each $boardList as board (board.id)}
    function create_each_block$1(key_1, ctx) {
    	let li;
    	let span0;
    	let t0_value = /*board*/ ctx[5].name + "";
    	let t0;
    	let t1;
    	let span1;
    	let icon;
    	...
    	let mounted;
    	let dispose;
    	icon = new Icon({ props: { data: trash }, $$inline: true });
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			attr_dev(span0, "class", "board-name svelte-18f01vg");
    			add_location(span0, file$3, 55, 4, 1248);
    			attr_dev(span1, "class", "delete-btn svelte-18f01vg");
    			add_location(span1, file$3, 56, 4, 1297);

    			attr_dev(li, "class", li_class_value = "" + (null_to_empty(/*board*/ ctx[5].id === /*$activeBoard*/ ctx[1].id
    			? "active"
    			: "") + " svelte-18f01vg"));

    			attr_dev(li, "data-id", li_data_id_value = /*board*/ ctx[5].id);
    			add_location(li, file$3, 50, 3, 1122);
    			this.first = li;
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(span1, "click", /*deleteBoard*/ ctx[4], false, false, false),
    					listen_dev(li, "click", /*changeActiveBoard*/ ctx[3], false, false, false)
    				];
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*$boardList*/ 1) && t0_value !== (t0_value = /*board*/ ctx[5].name + "")) set_data_dev(t0, t0_value);

    			if (!current || dirty & /*$boardList, $activeBoard*/ 3 && li_class_value !== (li_class_value = "" + (null_to_empty(/*board*/ ctx[5].id === /*$activeBoard*/ ctx[1].id
    			? "active"
    			: "") + " svelte-18f01vg"))) {
    				attr_dev(li, "class", li_class_value);
    			}

    			if (!current || dirty & /*$boardList*/ 1 && li_data_id_value !== (li_data_id_value = /*board*/ ctx[5].id)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(50:2) {#each $boardList as board (board.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value = /*$boardList*/ ctx[0];
    	validate_each_argument(each_value);
    	const get_key = ctx => /*board*/ ctx[5].id;
    	...
    	icon = new Icon({ props: { data: plus }, $$inline: true });

    	const block = {
    		c: function create() {
    			section = element("section");
    			h3 = element("h3");
    			h3.textContent = "📒 Online Post-it";
    			t1 = space();
    			ul = element("ul");
    			...
    			li = element("li");
    			create_component(icon.$$.fragment);
    			attr_dev(h3, "class", "svelte-18f01vg");
    			add_location(h3, file$3, 47, 1, 1045);
    			attr_dev(li, "class", "add-btn svelte-18f01vg");
    			add_location(li, file$3, 64, 2, 1421);
    			add_location(ul, file$3, 48, 1, 1073);
    			attr_dev(section, "class", "svelte-18f01vg");
    			add_location(section, file$3, 46, 0, 1034);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(li, "click", /*addBoard*/ ctx[2], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$boardList, $activeBoard, changeActiveBoard, deleteBoard, trash*/ 27) {
    				each_value = /*$boardList*/ ctx[0];
    				validate_each_argument(each_value);
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context$1, get_key);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let $boardList;
    	let $activeBoard;
    	validate_store(boardList, "boardList");
    	component_subscribe($$self, boardList, $$value => $$invalidate(0, $boardList = $$value));
    	validate_store(activeBoard, "activeBoard");
    	component_subscribe($$self, activeBoard, $$value => $$invalidate(1, $activeBoard = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("BoardList", slots, []);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<BoardList> was created with unknown prop '${key}'`);
    	});
    	...
    	return [$boardList, $activeBoard, addBoard, changeActiveBoard, deleteBoard];
    }

    class BoardList extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src/components/PostIt.svelte generated by Svelte v3.38.2 */
    const file$2 = "src/components/PostIt.svelte";
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span = element("span");
    			t = text(/*title*/ ctx[0]);
    			attr_dev(span, "class", "svelte-12s81j8");
    			add_location(span, file$2, 176, 5, 3833);
    			attr_dev(div, "class", "title svelte-12s81j8");
    			add_location(div, file$2, 175, 4, 3781);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div, "click", /*toggleEditTitle*/ ctx[6], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			input = element("input");
    			attr_dev(input, "class", "title svelte-12s81j8");
    			input.required = true;
    			input.autofocus = true;
    			attr_dev(input, "maxlength", "50");
    			add_location(input, file$2, 165, 4, 3599);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input, "blur", /*updateTitle*/ ctx[9], false, false, false),
    					listen_dev(input, "keydown", handleInputBlur, false, false, false)
    				];
    ...
    function create_if_block$1(ctx) {
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*isEditContent*/ ctx[4]) return create_if_block_1;
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if_block.c();
    			attr_dev(div, "class", "content-area svelte-12s81j8");
    			add_location(div, file$2, 190, 2, 4114);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			if_block.m(div, null);
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$2, 201, 5, 4388);
    			attr_dev(div, "class", "content svelte-12s81j8");
    			add_location(div, file$2, 200, 4, 4332);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, span);
    			...
    			if (!mounted) {
    				dispose = listen_dev(div, "click", /*toggleEditContent*/ ctx[7], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(textarea, "class", "content svelte-12s81j8");
    			textarea.required = true;
    			textarea.autofocus = true;
    			textarea.value = /*content*/ ctx[1];
    			add_location(textarea, file$2, 192, 4, 4168);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(textarea, "blur", /*updateContent*/ ctx[10], false, false, false),
    					listen_dev(textarea, "keydown", handleInputBlur, false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*content*/ 2) {
    				prop_dev(textarea, "value", /*content*/ ctx[1]);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$2(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*isEditTitle*/ ctx[3]) return create_if_block_2;
    	...
    	icon0 = new Icon({
    			props: {
    				data: /*isOpen*/ ctx[2] ? chevronUp : chevronDown
    			},
    			$$inline: true
    		});

    	icon1 = new Icon({ props: { data: times }, $$inline: true });
    	let if_block1 = /*isOpen*/ ctx[2] && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			if (if_block1) if_block1.c();
    			attr_dev(div0, "class", "title-area svelte-12s81j8");
    			add_location(div0, file$2, 163, 2, 3549);
    			add_location(span0, file$2, 181, 3, 3912);
    			add_location(span1, file$2, 184, 3, 4010);
    			attr_dev(div1, "class", "icon-area svelte-12s81j8");
    			add_location(div1, file$2, 180, 2, 3885);
    			attr_dev(header, "class", "svelte-12s81j8");
    			add_location(header, file$2, 159, 1, 3466);
    			attr_dev(article, "style", /*style*/ ctx[5]);
    			attr_dev(article, "class", article_class_value = "" + (null_to_empty(/*isOpen*/ ctx[2] ? "shadow" : "") + " svelte-12s81j8"));
    			add_location(article, file$2, 154, 0, 3382);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(span0, "click", /*updateIsOpen*/ ctx[8], false, false, false),
    					listen_dev(span1, "click", /*deletePostIt*/ ctx[11], false, false, false),
    					listen_dev(header, "mousedown", /*onMousedown*/ ctx[13], false, false, false),
    					listen_dev(header, "dragstart", dragstart_handler, false, false, false),
    					listen_dev(article, "mouseup", /*updateSize*/ ctx[12], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			const icon0_changes = {};
    			if (dirty & /*isOpen*/ 4) icon0_changes.data = /*isOpen*/ ctx[2] ? chevronUp : chevronDown;
    			...
    			if (!current || dirty & /*isOpen*/ 4 && article_class_value !== (article_class_value = "" + (null_to_empty(/*isOpen*/ ctx[2] ? "shadow" : "") + " svelte-12s81j8"))) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function toggleEditTitle() {
    		$$invalidate(3, isEditTitle = !isEditTitle);
    	}

    	function toggleEditContent() {
    		$$invalidate(4, isEditContent = !isEditContent);
    	}
    	...
    	const writable_props = ["id", "boardId", "title", "content", "position", "size", "isOpen", "zIndex"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<PostIt> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("boardId" in $$props) $$invalidate(15, boardId = $$props.boardId);
    		if ("title" in $$props) $$invalidate(0, title = $$props.title);
    		if ("content" in $$props) $$invalidate(1, content = $$props.content);
    		if ("position" in $$props) $$invalidate(16, position = $$props.position);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("isOpen" in $$props) $$invalidate(2, isOpen = $$props.isOpen);
    		if ("zIndex" in $$props) $$invalidate(18, zIndex = $$props.zIndex);
    		if ("isEditTitle" in $$props) $$invalidate(3, isEditTitle = $$props.isEditTitle);
    		if ("isEditContent" in $$props) $$invalidate(4, isEditContent = $$props.isEditContent);
    		...
    		if ("y" in $$props) $$invalidate(25, y = $$props.y);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*isOpen*/ 4) {
    			$$invalidate(5, style = `--x:${x}px; --y:${y}px; --width:${width}px; --height:${height}px;` + `--resize:${isOpen ? "both" : "none"}`);
    		}
    	};
    ...
    class PostIt extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*boardId*/ ctx[15] === undefined && !("boardId" in props)) {
    			console.warn("<PostIt> was created without expected prop 'boardId'");
    		}

    		if (/*title*/ ctx[0] === undefined && !("title" in props)) {
    			console.warn("<PostIt> was created without expected prop 'title'");
    		}

    		if (/*content*/ ctx[1] === undefined && !("content" in props)) {
    			console.warn("<PostIt> was created without expected prop 'content'");
    		}

    		if (/*position*/ ctx[16] === undefined && !("position" in props)) {
    			console.warn("<PostIt> was created without expected prop 'position'");
    		}

    		if (/*size*/ ctx[17] === undefined && !("size" in props)) {
    			console.warn("<PostIt> was created without expected prop 'size'");
    		}

    		if (/*isOpen*/ ctx[2] === undefined && !("isOpen" in props)) {
    			console.warn("<PostIt> was created without expected prop 'isOpen'");
    		}

    		if (/*zIndex*/ ctx[18] === undefined && !("zIndex" in props)) {
    			console.warn("<PostIt> was created without expected prop 'zIndex'");
    		}
    	}
    ...
    function create_else_block(ctx) {
    	let div;
    	let span;
    	let t_value = /*$activeBoard*/ ctx[0].name + "";
    	let t;
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			span = element("span");
    			t = text(t_value);
    			attr_dev(span, "class", "svelte-z31jbd");
    			add_location(span, file$1, 49, 4, 1133);
    			attr_dev(div, "class", "board-name svelte-z31jbd");
    			add_location(div, file$1, 48, 3, 1082);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, span);
    			...
    			if (!mounted) {
    				dispose = listen_dev(div, "click", /*toggleEdit*/ ctx[3], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*$activeBoard*/ 1 && t_value !== (t_value = /*$activeBoard*/ ctx[0].name + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    			mounted = false;
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			input = element("input");
    			attr_dev(input, "class", "board-name svelte-z31jbd");
    			input.required = true;
    			input.autofocus = true;
    			attr_dev(input, "maxlength", "50");
    			add_location(input, file$1, 38, 3, 889);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, input, anchor);
    			set_input_value(input, /*$activeBoard*/ ctx[0].name);
    			input.focus();

    			if (!mounted) {
    				dispose = [
    					listen_dev(input, "input", /*input_input_handler*/ ctx[7]),
    					listen_dev(input, "blur", /*updateBoardName*/ ctx[4], false, false, false),
    					listen_dev(input, "keydown", handleInputBlur, false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$activeBoard*/ 1 && input.value !== /*$activeBoard*/ ctx[0].name) {
    				set_input_value(input, /*$activeBoard*/ ctx[0].name);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    // (55:2) {#each filteredPostItList as postIt (postIt.id)}
    function create_each_block(key_1, ctx) {
    	let first;
    	let postit;
    	let current;
    	const postit_spread_levels = [/*postIt*/ ctx[8]];
    	let postit_props = {};

    	for (let i = 0; i < postit_spread_levels.length; i += 1) {
    		postit_props = assign(postit_props, postit_spread_levels[i]);
    	}
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			const postit_changes = (dirty & /*filteredPostItList*/ 4)
    			? get_spread_update(postit_spread_levels, [get_spread_object(/*postIt*/ ctx[8])])
    			: {};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(55:2) {#each filteredPostItList as postIt (postIt.id)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*isEdit*/ ctx[1]) return create_if_block;
    		return create_else_block;
    	}

    	let current_block_type = select_block_type(ctx);
    	let if_block = current_block_type(ctx);
    	let each_value = /*filteredPostItList*/ ctx[2];
    	validate_each_argument(each_value);
    	const get_key = ctx => /*postIt*/ ctx[8].id;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(header, file$1, 36, 1, 862);
    			attr_dev(div, "class", "post-it-area");
    			add_location(div, file$1, 53, 1, 1196);
    			attr_dev(section, "id", "board");
    			attr_dev(section, "class", "svelte-z31jbd");
    			add_location(section, file$1, 35, 0, 816);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(section, "dblclick", /*addPostIt*/ ctx[5], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*filteredPostItList*/ 4) {
    				each_value = /*filteredPostItList*/ ctx[2];
    				validate_each_argument(each_value);
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context, get_key);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let filteredPostItList;
    	let $postItList;
    	let $activeBoard;
    	validate_store(postItList, "postItList");
    	component_subscribe($$self, postItList, $$value => $$invalidate(6, $postItList = $$value));
    	validate_store(activeBoard, "activeBoard");
    	component_subscribe($$self, activeBoard, $$value => $$invalidate(0, $activeBoard = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Board", slots, []);
    	let isEdit = false;

    	function toggleEdit() {
    		$$invalidate(1, isEdit = !isEdit);
    	}
    	...
    	function input_input_handler() {
    		$activeBoard.name = this.value;
    		activeBoard.set($activeBoard);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("filteredPostItList" in $$props) $$invalidate(2, filteredPostItList = $$props.filteredPostItList);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$postItList, $activeBoard*/ 65) {
    			$$invalidate(2, filteredPostItList = $postItList.filter(postIt => postIt.boardId === $activeBoard.id));
    		}
    	};
    ...
    function create_fragment(ctx) {
    	...
    	let board;
    	let current;
    	boardlist = new BoardList({ $$inline: true });
    	board = new Board({ $$inline: true });

    	const block = {
    		c: function create() {
    			main = element("main");
    			create_component(boardlist.$$.fragment);
    			t = space();
    			create_component(board.$$.fragment);
    			attr_dev(main, "class", "svelte-1phw4fk");
    			add_location(main, file, 5, 0, 124);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(boardlist, main, null);
    			append_dev(main, t);
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(boardlist.$$.fragment, local);
    			transition_in(board.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(boardlist.$$.fragment, local);
    			transition_out(board.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(main);
    			destroy_component(boardlist);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ BoardList, Board });
    	return [];
    }
